...
#define MOTHERBOARD 3 // SANGUINO 1, MOTHERBOARD12 = 2, MEGA 3, ATMEGA328 4, HYDRA 64
...
const float Y_STROKE = 200; // (200 / 25.4); // inches of y axis travel
const float Z_STROKE = 120; // (120 / 25.4); // inches of z axis travel
